	...
	<main>
		<aside class="asidebar">
			<ul class="aside_menu">
				...
				<li><a href="condition.jsp" id="bold-menu">수업 검색</a></li>
		...
		<section class="main_section">
			...
			<div>
				<label for="year">년도:</label> <input type="number" id="year"
					name="year" min="2020" max="2023"></div>
					<div>
					<label for="semester">학기:</label> <input
					type="number" id="semester" name="semester" min="1" max="2"></div>
				<div>
				<label
					for="major">전공:</label> <input type="text" id="major" name="major"><br>
